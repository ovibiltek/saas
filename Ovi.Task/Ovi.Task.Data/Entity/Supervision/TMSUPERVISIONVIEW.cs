...
{
    public class TMSUPERVISIONVIEW
    {
        public virtual int SPV_ID { get; set; }
        ...
        public virtual int? SPV_TASK { get; set; }
        ...
        public virtual string SPV_TASKTYPE { get; set; }
        public virtual string SPV_REGION { get; set; }
        public virtual string SPV_TRADE { get; set; }
        public virtual string SPV_SUPPLIER { get; set; }
        public virtual decimal? SPV_SCORE { get; set; }
    }
}