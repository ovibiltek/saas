...
{
    public class TMPSPLINESVIEW
    {
        public virtual long PPL_ID { get; set; }

        public virtual long PPL_PSPCODE { get; set; }
        ...
        public virtual long PPL_TASK { get; set; }
        ...
        public virtual long PPL_TSKACTLINE { get; set; }
        ...
        public virtual decimal? PPL_PRICE { get; set; }

        public virtual decimal? PPL_TOTAL { get; set; }
