...
namespace Ovi.Task.Data.Entity
{
    public class TMSTATUSAUTHVIEW
    {
        ...
        public virtual string SAU_TYPEDESC { get; set; }

        public virtual string SAU_DEPARTMENT { get; set; }

        public virtual string SAU_FROM { get; set; }

        public virtual string SAU_PFROM { get; set; }

        public virtual string SAU_FROMDESC { get; set; }

        public virtual string SAU_TO { get; set; }

        public virtual string SAU_PTO { get; set; }

        public virtual string SAU_TODESC { get; set; }
