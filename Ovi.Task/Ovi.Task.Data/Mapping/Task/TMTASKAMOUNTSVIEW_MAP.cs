...
{
    public sealed class TMTASKAMOUNTSVIEW_MAP : ClassMap<TMTASKAMOUNTSVIEW>
    {
        public TMTASKAMOUNTSVIEW_MAP()
        {
            Id(x => x.ANT_TASKID);
            ...
            Map(x => x.ANT_LABORCOST);
            Map(x => x.ANT_LABORCALC);
            Map(x => x.ANT_LABORPSP);
            Map(x => x.ANT_SERVCALC);
            Map(x => x.ANT_SERVPSP);
            Map(x => x.ANT_MISCCOSTRECEIVE_SERVICe);
            Map(x => x.ANT_MISCCOSTSALES_SERVICE);
            Map(x => x.ANT_MISCCOSTPSP_SERVICE);
            Map(x => x.ANT_MISCCOSTRECEIVE_PART);
            Map(x => x.ANT_MISCCOSTSALES_PART);
            Map(x => x.ANT_MISCCOSTPSP_PART);
            Map(x => x.ANT_PARTRECEIVE);
            Map(x => x.ANT_PARTPSP);
            Map(x => x.ANT_SERVICECODERECEIVE);
            Map(x => x.ANT_SERVICECODESALES);
            Map(x => x.ANT_SERVICECODEPSP);
            Map(x => x.ANT_EQUIPMENTRECEIVE);
            Map(x => x.ANT_EQUIPMENTSALES);
            Map(x => x.ANT_EQUIPMENTPSP);
            Map(x => x.ANT_TOTALCOST);
