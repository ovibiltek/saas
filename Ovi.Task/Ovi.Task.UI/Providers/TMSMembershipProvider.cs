...
namespace Ovi.Task.UI.Providers
{
    public class TMSMembershipProvider : MembershipProvider
    {
        ...
        {
            var user = UserManager.Instance.AuthenticateUser(usercode, password);
            if (user != null)
            {
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            ...
            {
                return new MembershipUser("TMSMembershipProvider", username,
                    UserManager.Instance.User.Code, UserManager.Instance.User.Code, null,
