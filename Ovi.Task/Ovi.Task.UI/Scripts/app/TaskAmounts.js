(function () {
    var grdTaskAmounts = null;
    var grdelm = $("#grdTaskAmounts");
    ...
    function itemSelect(row) {
        var selectedrecord = grdTaskAmounts.GetRowDataItem(row);
        $("[data-id]").removeClass("k-state-selected");
        row.addClass("k-state-selected");
        $(".page-header h6").html(selectedrecord.ANT_TASKID + " - " + selectedrecord.TSK_SHORTDESC);
    }
    ...
    function loadTaskAmounts() {
        ...
        grdTaskAmounts = new Grid({
            keyfield: "ANT_TASKID",
            columns: [
                {
                    type: "number",
                    field: "ANT_TASKID",
                    title: gridstrings.taskamounts[lang].taskid,
                    width: 150
                },
                {
                    type: "string",
                    field: "ANT_TASKSHORTDESC",
                    title: gridstrings.taskamounts[lang].shortdescription,
                    width: 350
                },
                {
                    type: "number",
                    field: "ANT_ACTCOUNT",
                    title: gridstrings.taskamounts[lang].activitycount,
                    width: 130
                },
                {
                    type: "string",
                    field: "ANT_TASKORGANIZATION",
                    title: gridstrings.taskamounts[lang].taskorganization,
                    width: 150
                },
                {
                    type: "string",
                    field: "ANT_TASKDEPARTMENT",
                    title: gridstrings.taskamounts[lang].taskdepartment,
                    width: 130
                },
                {
                    type: "string",
                    field: "ANT_TASKCUSTOMER",
                    title: gridstrings.taskamounts[lang].taskcustomer,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_TASKCUSTOMERDESC",
                    title: gridstrings.taskamounts[lang].taskcustomerdesc,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_BRANCH",
                    title: gridstrings.taskamounts[lang].branch,
                    width: 150
                },
                {
                    type: "string",
                    field: "ANT_BRANCHDESC",
                    title: gridstrings.taskamounts[lang].branchdesc,
                    width: 150
                },
                {
                    type: "string",
                    field: "ANT_REGION",
                    title: gridstrings.taskamounts[lang].region,
                    width: 130
                },
                {
                    type: "string",
                    field: "ANT_PROVINCE",
                    title: gridstrings.taskamounts[lang].province,
                    width: 130
                },
                {
                    type: "string",
                    field: "ANT_CUSTOMERPM",
                    title: gridstrings.taskamounts[lang].customerprojectmanager,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_CUSTOMERGROUP",
                    title: gridstrings.taskamounts[lang].customergroup,
                    width: 130
                },
                {
                    type: "string",
                    field: "ANT_CUSTOMERTYPE",
                    title: gridstrings.taskamounts[lang].customertype,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_TASKSTATUS",
                    title: gridstrings.taskamounts[lang].taskstatus,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_TASKSTATUSDESC",
                    title: gridstrings.taskamounts[lang].taskstatusdesc,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_TASKPRIORITY",
                    title: gridstrings.taskamounts[lang].taskpriority,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_TASKTYPE",
                    title: gridstrings.taskamounts[lang].tasktype,
                    width: 130
                },
                {
                    type: "string",
                    field: "ANT_TASKTASKTYPE",
                    title: gridstrings.taskamounts[lang].tasktasktype,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_TASKCATEGORY",
                    title: gridstrings.taskamounts[lang].taskcategory,
                    width: 130
                },
                {
                    type: "number",
                    field: "ANT_PSPCODE",
                    title: gridstrings.taskamounts[lang].pspcode,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_PSPSTATUS",
                    title: gridstrings.taskamounts[lang].pspstatus,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_TASKREQUESTEDBY",
                    title: gridstrings.taskamounts[lang].taskrequestedby,
                    width: 130
                },
                {
                    type: "string",
                    field: "ANT_TASKCREATEDBY",
                    title: gridstrings.taskamounts[lang].taskcreatedby,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_USRGROUP",
                    title: gridstrings.taskamounts[lang].usrgroup,
                    width: 130
                },
                {
                    type: "datetime",
                    field: "ANT_TASKCREATED",
                    title: gridstrings.taskamounts[lang].taskcreated,
                    width: 150
                },
                {
                    type: "datetime",
                    field: "ANT_TASKREQUESTED",
                    title: gridstrings.taskamounts[lang].taskrequested,
                    width: 250
                },
                {
                    type: "datetime",
                    field: "ANT_TASKDEADLINE",
                    title: gridstrings.taskamounts[lang].taskdeadline,
                    width: 250
                },
                {
                    type: "datetime",
                    field: "ANT_BOOKINGSTART",
                    title: gridstrings.taskamounts[lang].bookingstart,
                    width: 150
                },
                {
                    type: "datetime",
                    field: "ANT_TASKHOLDDATE",
                    title: gridstrings.taskamounts[lang].taskholddate,
                    width: 150
                },
                {
                    type: "datetime",
                    field: "ANT_TASKCOMPLETED",
                    title: gridstrings.taskamounts[lang].taskcompleted,
                    width: 250
                },
                {
                    type: "datetime",
                    field: "ANT_TASKCLOSED",
                    title: gridstrings.taskamounts[lang].taskclosed,
                    width: 250
                },
                {
                    type: "string",
                    field: "ANT_TASKHOLDREASON",
                    title: gridstrings.taskamounts[lang].taskholdreason,
                    width: 150
                },
                {
                    type: "price",
                    field: "ANT_LABORCOST",
                    title: gridstrings.taskamounts[lang].laborcost,
                    width: 200
                },
                {
                    type: "price",
                    field: "ANT_LABORCALC",
                    title: gridstrings.taskamounts[lang].laborcalc,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_LABORPSP",
                    title: gridstrings.taskamounts[lang].laborpsp,
                    width: 130
                },
                {
                    type: "price",
                    field: "ANT_SERVCALC",
                    title: gridstrings.taskamounts[lang].servcalc,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_SERVPSP",
                    title: gridstrings.taskamounts[lang].servpsp,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_MISCCOSTRECEIVE_SERVICe",
                    title: gridstrings.taskamounts[lang].misccostreceiveservice,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_MISCCOSTSALES_SERVICE",
                    title: gridstrings.taskamounts[lang].misccostsalesservice,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_MISCCOSTPSP_SERVICE",
                    title: gridstrings.taskamounts[lang].misccostpspservice,
                    width: 250
                },
                { type: "price", field: "ANT_MISCCOSTRECEIVE_PART", title: gridstrings.taskamounts[lang].misccostreceivepart, width: 250 },
                {
                    type: "price",
                    field: "ANT_MISCCOSTSALES_PART",
                    title: gridstrings.taskamounts[lang].misccostsalespart,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_MISCCOSTPSP_PART",
                    title: gridstrings.taskamounts[lang].misccostpsppart,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_PARTRECEIVE",
                    title: gridstrings.taskamounts[lang].partreceive,
                    width: 250
                },
                { type: "price", field: "ANT_PARTPSP", title: gridstrings.taskamounts[lang].partpsp, width: 250 },
                {
                    type: "price",
                    field: "ANT_SERVICECODERECEIVE",
                    title: gridstrings.taskamounts[lang].servicecodereceive,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_SERVICECODESALES",
                    title: gridstrings.taskamounts[lang].servicecodesales,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_SERVICECODEPSP",
                    title: gridstrings.taskamounts[lang].servicecodepsp,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_EQUIPMENTRECEIVE",
                    title: gridstrings.taskamounts[lang].equipmentreceive,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_EQUIPMENTSALES",
                    title: gridstrings.taskamounts[lang].equipmentsales,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_EQUIPMENTPSP",
                    title: gridstrings.taskamounts[lang].equipmentpsp,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_TOTALCOST",
                    title: gridstrings.taskamounts[lang].totalcost,
                    width: 250
                },
                {
                    type: "price",
                    field: "ANT_TOTALPSP",
                    title: gridstrings.taskamounts[lang].totalpsp,
                    width: 250
                }
            ],
            fields:
            {
                ...
                ANT_LABORCOST: { type: "number" },
                ANT_LABORCALC: { type: "number" },
                ANT_LABORPSP: { type: "number" },
                ANT_SERVCALC: { type: "number" },
                ANT_SERVPSP: { type: "number" },
                ANT_SERVICECODERECEIVE: { type: "number" },
                ANT_SERVICECODESALES: { type: "number" },
                ANT_SERVICECODEPSP: { type: "number" },
                ANT_EQUIPMENTRECEIVE: { type: "number" },
                ANT_EQUIPMENTSALES: { type: "number" },
                ANT_EQUIPMENTPSP: { type: "number" },
                ANT_MISCCOSTRECEIVE_SERVICe: { type: "number" },
                ANT_MISCCOSTSALES_SERVICE: { type: "number" },
                ANT_MISCCOSTPSP_SERVICE: { type: "number" },
                ANT_MISCCOSTRECEIVE_PART: { type: "number" },
                ANT_MISCCOSTSALES_PART: { type: "number" },
                ANT_MISCCOSTPSP_PART: { type: "number" },
                ANT_PARTRECEIVE: { type: "number" },
                ANT_PARTPSP: { type: "number" },
                ANT_TOTALCOST: { type: "number" },
            ...
            datasource: "/Api/ApiTask/ListAmounts",
            selector: "#grdTaskAmounts",
            name: "grdTaskAmounts",
    ...
    function runFilter() {
        ...
        grdTaskAmounts.RunFilter(gridfilter);
