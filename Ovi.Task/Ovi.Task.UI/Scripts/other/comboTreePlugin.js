...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.createSourceHTML = function () {
        ...
        sourceHTML += this.createSourceSubItemsHTML(this.options.source, true);
        return sourceHTML;
    };

    ComboTree.prototype.createFilterHTMLForMultiSelect = function (){
        return '<input id="' + this.comboTreeId + 'MultiFilter" type="text" class="multiplesFilter" placeholder="' + applicationstrings[lang].typetofilter + '"/>';
    }

    ComboTree.prototype.createSourceSubItemsHTML = function (subItems, isFirstChild) {
        var subItemsHtml = "<UL " + (isFirstChild ? "" : "style=\"display:none;\"") + ">";
        for (var i=0; i<subItems.length; i++){
            subItemsHtml += this.createSourceItemHTML(subItems[i], false);
        }
        subItemsHtml += "</UL>";
        return subItemsHtml;
    }
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        ...
        itemHtml += '<span class="comboTreeParentPlus">' + (isThereSubs ? "+" : "&minus;") + "</span>";
        if (this.options.isMultiple)
    ...
    ComboTree.prototype.singleItemClick = function (ctItem) {
        ...
        if (this.options.singleItemClick && typeof (this.options.singleItemClick) == "function")
            this.options.singleItemClick(this._selectedItem);
    ...
    ComboTree.prototype.refreshInputVal = function () {
        ...
        this._elemInput.val(tmpTitle).trigger("change");
    }
